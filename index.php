...
<div id="lock"><img src="statics/landscape_mode.jpg" alt="" style="width:50%; margin-top:50%;"><br>
<h1 style="color:black; margin-top: 25px;"><b>Please rotate your device. </b><br> landscape mode is only supported.</h1>
</div>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed fixed-top"
        style="font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; font-size:18px; box-shadow: 0px 0px 10px 0px black;">
            ...
            <b>
                <ul class="navbar-nav ">
                    <li class="nav-item nav-links" style="margin-left:15px;">
                        <a class="nav-link active text-nowrap" aria-current="page" href="home.php">Home Page</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap" href="send_money.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="all_cust.php">View The Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-family:forte;size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> GRIP
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/bank.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/transperent.png" alt="" style="width:100%; position:absolute; z-index:-1">
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Facilities Provided by us</b></h1>
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:black; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <h6> You can view the customer of the GRIP bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
