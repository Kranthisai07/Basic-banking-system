        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap active" href="all_cust.php">View The Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
...
echo "<tbody>";
        ...
        echo    '
            <tr>
              ...
              <button type="button" class="btn mybtn btn-outline-light btn-sm">Send Money</button>
              </a>
              </td>
            </tr>';
    }
